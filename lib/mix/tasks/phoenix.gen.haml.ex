defmodule Mix.Tasks.Phoenix.Gen.Haml do
  use Mix.Task

  @shortdoc "Generates controller, model and views for an HAML based resource"
  ...
  def run(args) do
    ...
    Mix.Phoenix.copy_from paths(), "priv/templates/phoenix.gen.haml", "", binding, [
      {:eex, "edit.html.eex",       "web/templates/#{path}/edit.html.haml"},
      {:eex, "form.html.eex",       "web/templates/#{path}/form.html.haml"},
      {:eex, "index.html.eex",      "web/templates/#{path}/index.html.haml"},
      {:eex, "new.html.eex",        "web/templates/#{path}/new.html.haml"},
      {:eex, "show.html.eex",       "web/templates/#{path}/show.html.haml"},
    ]
  ...
  defp raise_with_help do
    Mix.raise """
    mix phoenix.gen.haml expects both singular and plural names
    of the generated resource followed by any number of attributes:
        mix phoenix.gen.haml User users name:string
    """
  end
